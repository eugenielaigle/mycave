...
--
-- Host: localhost    Database: mycave
-- ------------------------------------------------------
...
--
-- Table structure for table `mycave`
--

DROP TABLE IF EXISTS `mycave`;
